...
const matrixFunctions = { // 함수 보관 객체
    ...
    warningColor: () => { // 경고 팝업창 꾸미기
        ...
        cells.forEach((cell) => {
            ...
            setTimeout(() => {
                cell.style.color = "#2E8B5D";
                cell.style.borderColor = "#2E8B5D";
    ...
    alertWarning: () => { // 경고 팝업창
        matrixFunctions.warningColor();
        matrixFunctions.popupManager();
    },
}
...
const runningResultMatrix = (result) => {
    ...
    result.matrixArea.addEventListener("click", () => {
        operator.popupManager();
        operator.resultPopupPrint( result );
    });
}
...
matrixFunctions.maxSizeMaker([matrixA, matrixB]);
interfaceFunctions.footerContent( "nameArea",  "Name : Juhwan Bae" );
interfaceFunctions.footerContent( "callArea",  "Call : 010-2167-2204" );
interfaceFunctions.footerContent( "emailArea",  "E-mail : qo8373@naver.com" );